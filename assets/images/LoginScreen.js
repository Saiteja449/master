...
const TrainingCheckboxGrid = () => {
  ...
  return (
    <View >
      ...
      <TouchableOpacity onPress={() => setSkillpopup(true)}>
        <Text>This skill isn’t in your profile</Text>
      </TouchableOpacity>
      ...
      <View style={[globle_Style.radio_con, { marginVertical: 20 }]}>
        <TouchableWithoutFeedback onPress={() => handleRadio(1, 'every_day', setTrainingMethodRadio, setTrainingMethod)}>
          <View style={[globle_Style.radioWapper,{borderRadius:40}, trainingmethodRadio === 1 ? globle_Style.active_wrapper : globle_Style.radioWapper,{borderRadius:40}]}>
        ...
        <TouchableWithoutFeedback onPress={() => handleRadio(2, 'alternative_day', setTrainingMethodRadio, setTrainingMethod)}>
          <View style={[globle_Style.radioWapper, trainingmethodRadio === 2 ? globle_Style.active_wrapper : globle_Style.radioWapper,{borderRadius:40}]}>
            <View style={globle_Style.stardp_con}>
      ...
      {/* <View style={globle_Style.skillpopup}>
        <View style={globle_Style.skillpopup_con}>
          <Text style={globle_Style.skillpopup_hd}>This skill isn’t in your profile</Text>
          <Text style={globle_Style.skillpopup_para}>Add this skill to your profile or remove it before sending the quotation.</Text>
          <View style={[globle_Style.skill_info, {}]}>
            <FlatList
              data={skills}
              keyExtractor={(item, index) => index.toString()}
...
const globle_Style = StyleSheet.create({
...
export default TrainingCheckboxGrid;
