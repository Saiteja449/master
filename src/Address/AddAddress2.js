...
import Map from '../../assets/images/mapmarker.svg'

const GOOGLE_MAPS_API_KEY = 'AIzaSyDdXjkRFWa4oV-WVPrlKvPLlbwix_hWwr0';

const AddAddress2 = ({ route }) => {
    ...
    const goToAddRessSearchScreen = () => {
        navigation.navigate('AddressSearch2', {
            lat,
            lng
        });
    }
            ...
            <View style={styles.addressContainer}>
                <View style={styles.address_info}>
                    <View style={styles.address_info_txt}>
                        <Map />
                        <Text style={[styles.addressText,]} numberOfLines={5} ellipsizeMode='tails'>
                ...
                <TouchableOpacity onPress={() => goToPreviousScreen()}>
                    <LinearGradient
                        colors={['#FBAB51', '#FE8705']} start={{ x: 0, y: 1 }} style={globle_Style.globle_btn}>
