...
import { Text, View, Image, TouchableWithoutFeedback, ScrollView, TextInput, TouchableOpacity, Alert, ActivityIndicator, PermissionsAndroid, Platform, Linking } from 'react-native';
...
const PersonalDetails = ({ }) => {
    ...
    function addressNavigation(type) {
        ...
        if (type === 'Permanent' && (PermanentLatitude !== 0.0 || PermanentLongitude !== 0.0)) {
            latitude = PermanentLatitude;
            longitude = PermanentLongitude;
        } else if (type === 'Service' && (serviceLatitude !== 0.0 || serviceLongitude !== 0.0)) {
                        ...
                        <TouchableWithoutFeedback>
                            <View style={globle_Style.per_dtl_itm}>
                                ...
                                <View style={{ textAlign: 'center' }}>
                                    <Text style={[globle_Style.pers_nav_txt, globle_Style.pers_nav_txt_act]}>Personal</Text>
                                </View>
                            </View>
                        </TouchableWithoutFeedback>
                        <TouchableWithoutFeedback>
                ...
                {isLoading ?
                    ...
                    <View style={globle_Style.form_sec}>
                        <View style={globle_Style.form_con}>
                            <View style={[globle_Style.form_info, { marginBottom: nameError ? 2 : 10 }]}>
                                <Text style={globle_Style.input_lable}>Your Name</Text>
                                <TextInput style={globle_Style.input_txt} placeholder='Enter Name' value={name} onChangeText={setName} />
                                {
                                    nameError ? <Text style={[globle_Style.errorText, { paddingHorizontal: 5, }]}>{nameError}</Text> : null
                                }
                            </View>
                            ...
                            <View style={globle_Style.edit_frm_itm}>
                                ...
                                <View style={globle_Style.edit_frm_input}>
                                    <TextInput style={[globle_Style.input_txt, globle_Style.prof_txt]} placeholder='Enter Email' value={email} onChangeText={setEmail} />
                                    {/* <Edit /> */}
                                </View>
                                {
                            ...
                            <View style={[globle_Style.form_info, { marginBottom: genderError ? 2 : 10 }]}>
                                {/* radio btn : */}
                                <Text style={globle_Style.input_lable}>Gender</Text>
                                <View style={globle_Style.radio_con}>
                                    <TouchableWithoutFeedback onPress={() => handleGender(1, "Male")}>
                                    ...
                                    <TouchableWithoutFeedback onPress={() => handleGender(2, "Female")}>
                                ...
                                {
                                    genderError ? <Text style={[globle_Style.errorText, { paddingHorizontal: 5, }]}>{genderError}</Text> : null
                                }
                            </View>

                            <TouchableOpacity style={[globle_Style.form_info, { marginBottom: dobError ? 2 : 10 }]} onPress={showDatePicker}>
                                <Text style={globle_Style.input_lable}>Your DOB</Text>
                                <TextInput style={globle_Style.input_txt} placeholder='DD / MM / YYYY' value={dob} onChangeText={setDob} editable={false} pointerEvents='none' />
                            ...
                            {
                                dobError ? <Text style={[globle_Style.errorText, { paddingHorizontal: 5, }]}>{dobError}</Text> : null
                            }
                            ...
                            <View style={[globle_Style.form_info, { marginBottom: nameError ? 2 : 10 }]}>
                                ...
                                <TouchableOpacity style={globle_Style.form_info} onPress={() => addressNavigation('Service')}>
                                    <View style={globle_Style.address_info}>
                                        <TextInput style={[globle_Style.input_txt, globle_Style.other_way]} placeholder='Enter Address' value={serviceAddress} editable={false} multiline={true} />
                                        <View>
                                            <LiveAddress style={globle_Style.loc_icon} />
                                        </View>
                                    </View>
                                ...
                                {
                                    serviceAddressError ? <Text style={[globle_Style.errorText, { paddingHorizontal: 5, }]}>{serviceAddressError}</Text> : null
                                }


                            </View>
                            <TouchableWithoutFeedback onPress={!isDisabled ? serviceNavigation : null}>
