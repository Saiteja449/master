                ...
                <View style={globle_Style.newjob_rate_con}>
                  <View style={[globle_Style.job_distc, globle_Style.all_quot_edit,]}>
                    <View style={[globle_Style.newjob_txt_rgt, {}]}>
                      <TouchableWithoutFeedback onPress={() => navigation.navigate('GroomingQuoteDetailEdit', { item: item, isEdit: true })}>
                        <Edit style={{}} />
...
export default GroomingAllQuotes;
