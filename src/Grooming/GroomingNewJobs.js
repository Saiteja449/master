      ...
      <View style={globle_Style.newjob_sec}>
        <View style={globle_Style.newjob_con}>
          ...
          <View style={globle_Style.newjob_btn}>
            ...
            <TouchableWithoutFeedback
              onPress={() =>
                navination.navigate('GroomingAllQuotes', {
                  item: item,
                  showmyquote: false,
                })
              }
            ...
            <TouchableOpacity
              onPress={() =>
                navination.navigate('GroomingQuoteDetails', {
                  item: item,
                  isEdit: false,
                })
              }
      ...
      >
        ...
        >
          ...
          <TouchableWithoutFeedback>
            <TouchableOpacity
              onPress={() =>
                navination.navigate('GroomingQuoteDetailEdit', {
                  item: item,
                  isEdit: true,
                })
              }
        ...
        >
          <LinearGradient
            ...
            style={[
              ...
              item.track_status != null && item.track_status == 'terminate'
                ? { opacity: 0.5 }
                : { opacity: 1 },
            ]}
          >
            ...
            >
              ...
              item.track_status == 'rejected'
                ? 'Update Grooming'
                : item.track_status == 'terminate'
                ? 'Terminated'
                : 'Start Grooming'}
            </Text>
          </LinearGradient>
    ...
    <View style={[globle_Style.active_servc_sec]}>
      ...
      <View style={globle_Style.act_serv_exted}>
        <View style={globle_Style.actv_serv_rgt}>
          <TouchableWithoutFeedback
            onPress={() =>
              navination.navigate('GroomingActiveJobDetail', { item: item })
            }
          >
