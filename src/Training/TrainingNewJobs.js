...
const TrainingNewJobs = () => {
  ...
  const fetchNewJobsApiData = async () => {
    const url = `${API_BASE_URL}provider/${userData.id}/newJobs/3`;
  ...
  const fetchMyQuoteApiData = async () => {
    const url = `${API_BASE_URL}provider/${userData.id}/myQuotes/3`;
  ...
  const fetchActiveJobsApiData = async () => {
    const url = `${API_BASE_URL}provider/${userData.id}/activeJobs/3`;
